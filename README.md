...
| serveralive | -                                | is emitted each time the repository makes a successfull request to the server            |
| repochange  | `object` data                    | is emitted each time status of toggles has been changed                                  |
|             |
