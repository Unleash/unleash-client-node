...
import { CollectedMetric, ImpactMetricsDataSink } from './impact-metrics/metric-types';
...
export interface MetricsOptions {
  ...
  metricRegistry?: ImpactMetricsDataSink;
}
...
export default class Metrics extends EventEmitter {
  ...
  private metricRegistry?: ImpactMetricsDataSink;
